...
const API_PRODUCTOS = SERVER + 'dashboard/ventas.php?action=';
const ENDPOINT_CATEGORIAS = SERVER + 'dashboard/ventas.php?action=readAll';
...
function llenarTabla(dataset) {
    ...
    dataset.map(function (row) {
        ...
        (row.estado_venta) ? icon = 'visibility' : icon = 'visibility_off';
        ...
        content += `
            <tr>
                ...
                <td class="contenido">
                    <button onclick="openUpdate(${row.id_venta})" class="btn-editar"><i class="fa-solid fa-pen-to-square"></i></button>
                    <button onclick="openDelete(${row.id_venta})" class="btn-eliminar"><i class="fa-solid fa-trash"></i></button>
                </td>               
            </tr>
        `;
    });
...
// Función para abrir el reporte de ventas.
function openReport() {
