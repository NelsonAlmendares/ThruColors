...
$pdf->startReport('Productos por marca', $_SESSION['nombre_empleado'], $_SESSION['apellido_empleado'], $_SESSION['codigo_empleado']);
...
if ($dataMarcas = $marca->readMarca()) { 
    ...
    foreach ($dataMarcas as $rowMarca) {
        //Se evalua si existen productos en la marca para mostrar, de lo contrario no se muestra
        if ($rowMarca['cantidad'] > 0) {
            // Se establece la fuente para los encabezados.        
            $pdf->setFont('Times', 'B', 11);
